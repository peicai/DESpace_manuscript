...
path = paste0(dir,"probs_0.5_0.7_final_objectmel1_rep1.rda")
load(path)
...
sce1$JointCluster <- ifelse(sce1$cell_ID %in% pattern_ids, 'in', 'out')

path = paste0(dir,"probs_0.5_0.7_final_objectmel2_rep1.rda")
load(path)
...
pattern_ids = pattern$cell_ID
sce2$JointCluster <- ifelse(sce2$cell_ID %in% pattern_ids, 'in', 'out')

path = paste0(dir,"probs_0.5_0.7_final_objectmel3_rep1.rda")
load(path)
...
pattern_ids = pattern$cell_ID
sce3$JointCluster <- ifelse(sce3$cell_ID %in% pattern_ids, 'in', 'out')

path = paste0(dir,"probs_0.5_0.7_final_objectmel4_rep1.rda")
load(path)
...
pattern_ids = pattern$cell_ID
sce4$JointCluster <- ifelse(sce4$cell_ID %in% pattern_ids, 'in', 'out')
...
sce.combined$JointCluster <- as.character(sce.combined$JointCluster)
sce.combined$JointCluster[sce.combined$JointCluster == "in"] <- "Cluster1"
sce.combined$JointCluster[sce.combined$JointCluster == "out"] <- "Cluster2"
...
sample_id = data.frame(colData(sce.combined)$sample_name)
sce.combined$JointCluster <- as.character(sce.combined$spatial.cluster)
sce.combined$JointCluster[sce.combined$JointCluster == "1"] <- "Cluster1"
sce.combined$JointCluster[sce.combined$JointCluster %in% c("2", "3")] <- "Cluster2"
sce.combined$JointCluster[sce.combined$JointCluster == "4"] <- "Cluster3"
