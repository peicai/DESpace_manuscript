...
my_theme = theme(legend.position = "none", 
                 ...
                 axis.text.x = element_text(angle = 22.5, hjust=0.5, size = rel(2.5)),
                 ...
                 plot.subtitle = element_text(hjust = 0.5, face = "bold", size=22.5))
...
AA2 = ggpubr::ggarrange(gg_roc_melanoma[[1]] + labs(title = "melanoma") + my_theme,
                        gg_roc_melanoma[[2]] + ylab("") + labs("") + my_theme,
                        gg_roc_melanoma[[3]] + ylab("") + labs("") + my_theme,
                        gg_roc_melanoma[[4]] + ylab("") + labs("") + my_theme,
                        gg_roc_melanoma[[5]] + ylab("") + labs("") + my_theme,
                        ncol = 5, nrow = 1)
AA = ggpubr::ggarrange( AA1, AA2, legend, 
