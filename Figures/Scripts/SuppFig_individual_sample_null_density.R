...
######################################################
############################# output #####################
(AA = egg::ggarrange( plots = list(AA1 + labs(title = "LIBD") + theme(plot.title = element_text(hjust = 0, face = "bold", size=10),
                                                                      legend.position = "none"),
                                   AA2 +  labs(title = "melanoma") + theme(plot.title = element_text(hjust = 0, face = "bold", size=10),
                                                                           legend.position = "none"),
                                   AA3 +  labs(title = "mouse cerebellum") + theme(plot.title = element_text(hjust = 0, face = "bold", size=10),
                                                                                   legend.position = "none")
),
